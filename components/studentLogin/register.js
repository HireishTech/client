...
import { trueOpenLogin } from '../../redux/actions/studentLoginAction';
...
export default function Register() {
  ...
  return (
    <>
      ...
      <button className="bg-transparent hover:bg-orange-500 text-orange-500 font-semibold hover:text-white py-1.5 px-2 border border-orange-500 hover:border-transparent rounded mb-2" type="button" onClick={()=>Register()} >
        Register
      </button>
      ...
      {error &&
        <div id="alert-2" className="flex p-4 mt-4 bg-red-300 rounded-lg dark:bg-red-300" role="alert">
          <FontAwesomeIcon className="flex-shrink-0 w-5 h-5 text-red-700 dark:text-red-800" icon={faExclamationTriangle} />
      ...
      {success && 
        <div id="alert-3" className="flex p-4 mt-4 bg-green-300 rounded-lg dark:bg-green-200" role="alert">
          <FontAwesomeIcon className="flex-shrink-0 w-5 h-5 text-green-700 dark:text-green-800" icon={faCheck} />
