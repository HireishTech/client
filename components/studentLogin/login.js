...
import { trueOpenRegister } from '../../redux/actions/studentLoginAction';
...
export default function Login() {
  ...
  return (
    <>
      ...
      <button className="bg-transparent hover:bg-orange-500 text-orange-500 font-semibold hover:text-white py-1.5 px-2 border border-orange-500 hover:border-transparent rounded mb-2" type="button" onClick={()=> Login()} >
        Sign In
      </button>
